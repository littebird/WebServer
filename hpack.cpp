...
namespace Hpack {
    ...
    DynamicTable::DynamicTable(const uint32_t &tableSize, const uint32_t &maxSize, std::deque<std::pair<std::string, std::string> > &&entrys) noexcept:
    ...
    void DynamicTable::setTableSize(const uint32_t tableSize)
    {
    ...
    void DynamicTable::setMaxSize(const uint32_t maxSize)
    {
